...
// event
export const TOPIC_MANAGER_DATABASE_EVENT_ERROR =
  'TOPIC_MANAGER_DATABASE_EVENT_ERROR'
export const TOPIC_MANAGER_DATABASE_EVENT_MESSAGE =
  'TOPIC_MANAGER_DATABASE_EVENT_MESSAGE'
export const TOPIC_MANAGER_DATABASE_EVENT_FEEDBACK =
  'TOPIC_MANAGER_DATABASE_EVENT_FEEDBACK'
export const TOPIC_MANAGER_DATABASE_EVENT_VIEW =
  'TOPIC_MANAGER_DATABASE_EVENT_VIEW'
// performance
export const TOPIC_MANAGER_DATABASE_EVENT_PERFORMANCE =
