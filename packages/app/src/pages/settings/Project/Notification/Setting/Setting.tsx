...
const Setting: React.FC = () => {
  ...
  React.useEffect(() => {
    notificationModel.dispatch.getSetting({ project_id })
  }, [notificationModel.dispatch, project_id])
  ...
  const handleBrowserChange = React.useCallback(
    ...
    [appModel.dispatch, form, notificationModel.dispatch, project_id]
  )
  const handleFinish = React.useCallback(
    ...
    [form, notificationModel.dispatch, project_id]
  )
